...
oMultiply_Text = {"container": o_QQuickView, "text": "×", "type": "Text", "unnamed": 1, "visible": True}
oPlus_Text = {"container": o_QQuickView, "text": "+", "type": "Text", "unnamed": 1, "visible": True}
oMinus_Text = {"container": o_QQuickView, "text": "−", "type": "Text", "unnamed": 1, "visible": True}
oEqual_Text = {"container": o_QQuickView, "text": "=", "type": "Text", "unnamed": 1, "visible": True}
...
o0_Text = {"container": o_QQuickView, "text": 0, "type": "Text", "unnamed": 1, "visible": True}
...
o4_Text = {"container": o_QQuickView, "text": 4, "type": "Text", "unnamed": 1, "visible": True}
